...
def plot_graph_1(
    ...
    eixos1[0].set_title(f'Simulação com Suavização FV | BESS: {bess_capacidade_kwh} kWh | PV: {(potencia_pico_fv_curto/(ceu_aberto*EFICIENCIA_FV)):.2f} kWp ({dias_simulacao*24} Horas)', fontsize=16)
...
def plot_graph_4(
    ...
    with st.spinner("Executando análise de sensibilidade (Gráfico 4)... Isso pode levar um momento."):
        ...
        # Linhas: 0 a 1000 kWp em 5 passos (0, 250, 500, 750, 1000, 1250)
        fv_range_kwp = np.linspace(0, 1250, 6)
